...
def xingdian():
    ...
    cost = [24.3846 + 46, 5.4781 + 20, 15.1929 + 22, 11.0518 + 24, 8.23 + 20, 10.21 + 21, 13.3 + 16, 15.7 + 23]
    score = [0.8421, 0.8077, 0.8254, 0.8571, 0.8201, 0.8318, 0.8414, 0.8058]
    markers = ['d', 's', '^', 'h', 'p', 'D', '*', 'v']
    # 绘制散点图，并指定每个点的形状和标签
...
def shang():
    ...
    MICNN = [0.8414, 0.8401, 0.8402, 0.84, 0.836, 0.831]
